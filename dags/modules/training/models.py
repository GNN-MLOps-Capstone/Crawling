...
class GNNEncoder(torch.nn.Module):
    def __init__(self, hidden_dim, out_dim, news_feat_dim, keyword_feat_dim, stock_feat_dim,
        ...
        self.conv1 = HeteroConv({
            ('news', 'has_keyword', 'keyword'): GATConv((-1, -1), hidden_dim, heads=heads, concat=False,
                                                        dropout=dropout, add_self_loops=False),
            ('keyword', 'rev_has_keyword', 'news'): GATConv((-1, -1), hidden_dim, heads=heads, concat=False,
                                                            dropout=dropout, add_self_loops=False),
            ('news', 'has_stock', 'stock'): GATConv((-1, -1), hidden_dim, heads=heads, concat=False, dropout=dropout,
                                                    add_self_loops=False),
            ('stock', 'rev_has_stock', 'news'): GATConv((-1, -1), hidden_dim, heads=heads, concat=False,
                                                        dropout=dropout, add_self_loops=False),

            # Global Edges
            ('keyword', 'globally_related', 'stock'): GATConv((-1, -1), hidden_dim, heads=heads, concat=False,
                                                              dropout=dropout, add_self_loops=False),
            ('stock', 'rev_globally_related', 'keyword'): GATConv((-1, -1), hidden_dim, heads=heads, concat=False,
                                                                  dropout=dropout, add_self_loops=False),
        }, aggr='sum')
        ...
        self.conv3 = HeteroConv({
            ('news', 'has_keyword', 'keyword'): GATConv((-1, -1), out_dim, heads=1, concat=False, dropout=dropout,
                                                        add_self_loops=False),
            ('keyword', 'rev_has_keyword', 'news'): GATConv((-1, -1), out_dim, heads=1, concat=False, dropout=dropout,
                                                            add_self_loops=False),
            ('news', 'has_stock', 'stock'): GATConv((-1, -1), out_dim, heads=1, concat=False, dropout=dropout,
                                                    add_self_loops=False),
            ('stock', 'rev_has_stock', 'news'): GATConv((-1, -1), out_dim, heads=1, concat=False, dropout=dropout,
                                                        add_self_loops=False),
        }, aggr='sum')
...
class Model(torch.nn.Module):
    ...
    def decode(self, z_dict, edge_label_index_dict):
        preds = {}
    ...
    def forward(self, x_dict, edge_index_dict, edge_label_index_dict=None):
        ...
        if edge_label_index_dict:
            return self.decode(z_dict, edge_label_index_dict)
